...
export default function Sales({fetchSales , getToken , baseURL , fetchCountries , fetchavatars }) {
...
const [pageNumberSales, setPageNumberSales] = useState(0);

const handelPageChangeSales = (data) => {
  setPageNumberSales(data.selected + 1);
  console.log(pageNumberSales);
}
